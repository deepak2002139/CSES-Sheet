...
// ll solve(ll i, ll x, vl coins, ll count) 
// {
//     ll n = coins.size();
//     if (x < 0 )
//         return 1e9;
...
//     if (dp[i][x] != -1)
//         return dp[i][x];
//     ll take = 1 + solve(i, x - coins[i], coins, count );
//     ll nottake = solve(i + 1, x, coins, count);
